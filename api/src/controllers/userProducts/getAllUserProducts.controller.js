...
//       if (filters.User_lastName_filter) {
//         queryOptions.include[0].where.lastName = {
//           [Op.like]: `%${filters.User_lastName_filter}%`, //incluye
//         };
//       }

//       if (filters.Product_name_filter) {
//         queryOptions.include[1].where.name = {
//           [Op.like]: `%${filters.Product_name_filter}%`, //incluye 
//         };
//       }
...
//       if (filters.Products_category_order) {
//         // queryOptions.order.push(['category', filters.Products_category_order.toUpperCase()]);
//         queryOptions.include[1].order = [['category', filters.Products_category_order]];
